...
ggplot(long, aes(x = week_number, y = value)) + 
  ...
  labs(
    title = "\nFigure 4: Expected number of new versions over a year for the Tracker project", 
