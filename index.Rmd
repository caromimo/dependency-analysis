...
### Number of packages
The [dependency manifest file](https://github.com/canada-ca/tracker/blob/003a3d6e0452fb9a248a7d51fd5556bc03dfbcc6/frontend/package.json) uses a total of 72 packages. As packages were created and updated through time, **Figure 1** demonstrates that the annual number of updates increased from 2010 to 2018.
```{r, echo=FALSE}
data %>%
  group_by(year) %>%
