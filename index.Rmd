---
:itle: "Software dependancy analysis"
...
Using the following command, package names (both development and production) were extracted from the `package.json` and details for each was retrieved from the npm API.
