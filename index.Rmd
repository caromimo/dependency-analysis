...
Figure 4 illustrates the number of packages used in the [dependency manifest file](https://github.com/canada-ca/tracker/blob/003a3d6e0452fb9a248a7d51fd5556bc03dfbcc6/frontend/package.json) that existed per year between December 2010 and November 2020.  Note that the years 2010 and 2020 are not complete. Between 2011 and 2019, there was an increasing number of packages for which versions were being deployer per year.
...
Figure 5 illustrates the number of versions per package used in the [dependency manifest file](https://github.com/canada-ca/tracker/blob/003a3d6e0452fb9a248a7d51fd5556bc03dfbcc6/frontend/package.json) that existed per year between December 2010 and November 2020.  Note that the years 2010 and 2020 are not complete.
...
data %>%
  ...
  summarise(
    ...
    number_versions_over_package = number_of_versions / number_of_packages
            ) %>%
  ggplot(aes(year, number_versions_over_package)) +
  geom_col() +
  theme_classic() +
  labs(
